...
export const portalForgotPasswordPage = (page: Page, baseUrl: string) => ({
  goto: (): Promise<void> => page.goto(`${baseUrl}/forgot-password`).then(() => undefined),
...
export type PortalForgotPasswordPage = ReturnType<typeof portalForgotPasswordPage>;
